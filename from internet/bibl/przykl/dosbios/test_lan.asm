...
start:
	...
	mov	si, offset spr_porow1
	mov	di, offset spr_porow2
	porownaj
	pisz16z
	nwln
	...
	mov	si, offset spr_zcal1
	mov	di, offset spr_zcal2
	zcal
	pisz_dssi
	nwln
	...
	mov	si, offset spr_zcal2
	mov	di, offset spr_zcal3
	mov	cx, 2
	zcal_dl
	pisz_dssi
	nwln
	...
	pisz
	db	"Znajdowanie, ",0
	mov	si, offset spr_znaj1
	mov	di, offset spr_znaj2
	znajdz
	pisz16z
	nwln

	mov	si, offset spr_odwroc
	pisz_dssi
	nwln
	pisz
	db	"Odwracanie: ", 0
